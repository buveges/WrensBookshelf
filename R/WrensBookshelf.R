...
WrensBookshelf <- list(
  ...
  BoTheBraveCVDS = list(c("#039b9e","#e069a3","#f48347","#ccc8c9","#080808"),
                        ...
                        BestFor = "discrete",
                        Author = "Bethan Woolvin"),
  BurtDow = list(c("#f8eb79", "#ecb485",  "#dc659f", "#62af83","#b7a28d", "#a3474c", "#e2b0bc", "#89bfa8"),
                  c(1, 3, 4, 6, 7, 2, 5, 8),
                  CVDsafe = FALSE,
                  BestFor = "discrete",
                  Author = "Robert McCloskey"),
  BurtDowCVDS = list(c("#f8eb79",  "#dc659f", "#62af83","#a3474c", "#e2b0bc"),
                       c(1, 2, 3, 4, 5),
                       CVDsafe= TRUE,
                       BestFor = "discrete",
                       Author = "Robert McCloskey"),
  BlueberriesForSal = list(c("#f6c34b", "#e1d17c", "#e2d4d9",
                             ...
                             BestFor = "continuous",
                             Author = "Robert McCloskey"),
  GustavoTheShyGhostCover = list(c("#9b1c52",  "#ec008c", "#f16d99", "#ef4823",
                                         "#f7931e", "#69a3ba", "#869093", "#c2afa1"),
                                       c(2, 6, 5, 1, 3, 7, 4, 8),
                                       CVDsafe= FALSE,
                                       BestFor = "discrete",
                                       Author = "Flavia Z. Drago"),
  GustavoTheShyGhostGraveyard = list(c("#061f1e", "#062e36", "#20555a", "#3ba19f", "#a7dbd6",
  ...
  TheHoneybeeDiverging = list(c("#26221a", "#a49870", "#ebe6b5", "#fef59f", "#ffc10e", "#fbaa19"),
                                  c(1, 6, 2, 5, 3, 4),
                                  CVDsafe= TRUE,
                                  BestFor = "continuous",
                                  Author = "Isabelle Arsenault"),
  TheHoneybee = list(c("#26221a", "#a49870", "#ebe6b5", "#fbaa19", "#ffc10e", "#fef59f",
  ...
  YouMatter = list(c("#bfe2ef", "#c92463", "#a89933",
  ...
  WhatWellBuild = list(c("#23366d", "#2863af", "#7985c1", "#ad93c5",
                          ...
                          BestFor = "continuous",
                          Author = "Oliver Jeffers"),
  LittleBlueHouseBesideTheSeaCont = list(c("#008ba7", "#009db3", "#00aec4", "#26bdc2", "#8bd2d4", "#ade0ec",
  ...
  LittleBlueHouseBesideTheSeaDisc = list(c("#004d59", "#0087a1", "#61c3aa",
